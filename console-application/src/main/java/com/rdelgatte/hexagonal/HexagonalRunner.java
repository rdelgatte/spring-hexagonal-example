...
public class HexagonalRunner implements CommandLineRunner {
  ...
  public void run(String... args) {
    ...
    productService.createProduct(new Product(UUID.randomUUID(), "0123", "ANY_LABEL_0123", BigDecimal.valueOf(120.90)));
    productService.createProduct(new Product(UUID.randomUUID(), "0456", "ANY_LABEL_0456", BigDecimal.valueOf(130.90)));
    productService.createProduct(new Product(UUID.randomUUID(), "0789", "ANY_LABEL_0789", BigDecimal.valueOf(150.90)));
